...
def add_base_args(parser: ArgumentParser, before_prepared: bool):
    ...
    parser.add_argument("--precision", type=str, default=None, help="idek")
    parser.add_argument("--no-half", default=False, action="store_true", help="ads")
    parser.add_argument("--listen", default=False, action="store_true", help="ads")
    parser.add_argument("--enable-insecure-exrension-access", default=False, action="store_true", help="ads")
    parser.add_argument("--api", default=False, action="store_true", help="ads")
    parser.add_argument("--xformers", default=False, action="store_true", help="ads")
    parser.add_argument("--reinstall-xformers", default=False, action="store_true", help="ads")
